...
impl<O: 'static + IsA<MapPolygon>> MapPolygonExt for O {
    fn get_track(&self) -> Option<MapTrack> {
        unsafe {
    ...
    fn get_property_breakable(&self) -> bool {
        unsafe {
            ...
            gobject_ffi::g_object_get_property(self.to_glib_none().0 as *mut gobject_ffi::GObject, "bbreakable\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get().unwrap()
        }
    }
    ...
    fn set_property_breakable(&self, breakable: bool) {
        unsafe {
            gobject_ffi::g_object_set_property(self.to_glib_none().0 as *mut gobject_ffi::GObject, "bbreakable\0".as_ptr() as *const _, Value::from(&breakable).to_glib_none().0);
        }
    }
    ...
    fn get_property_shade_alpha(&self) -> f32 {
        unsafe {
            ...
            gobject_ffi::g_object_get_property(self.to_glib_none().0 as *mut gobject_ffi::GObject, "bshade-alpha\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get().unwrap()
        }
    }
    ...
    fn set_property_shade_alpha(&self, shade_alpha: f32) {
        unsafe {
            gobject_ffi::g_object_set_property(self.to_glib_none().0 as *mut gobject_ffi::GObject, "bshade-alpha\0".as_ptr() as *const _, Value::from(&shade_alpha).to_glib_none().0);
        }
    }
    ...
    fn get_property_shaded(&self) -> bool {
        unsafe {
            let mut value = Value::from_type(<bool as StaticType>::static_type());
            gobject_ffi::g_object_get_property(self.to_glib_none().0 as *mut gobject_ffi::GObject, "bshaded\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get().unwrap()
        }
    }
    ...
    fn set_property_shaded(&self, shaded: bool) {
        unsafe {
            gobject_ffi::g_object_set_property(self.to_glib_none().0 as *mut gobject_ffi::GObject, "bshaded\0".as_ptr() as *const _, Value::from(&shaded).to_glib_none().0);
        }
    }

    //fn set_property_track(&self, track: /*Unimplemented*/Fundamental: Pointer) {
    //    unsafe {
    //        gobject_ffi::g_object_set_property(self.to_glib_none().0 as *mut gobject_ffi::GObject, "btrack\0".as_ptr() as *const _, Value::from(&track).to_glib_none().0);
    //    }
    //}
    ...
    fn connect_property_breakable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            ...
            connect(self.to_glib_none().0 as *mut _, "notify::breakable",
    ...
    fn connect_property_shade_alpha_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Self) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0 as *mut _, "notify::shade-alpha",
    ...
    fn connect_property_shaded_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Self) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0 as *mut _, "notify::shaded",
    ...
    fn connect_property_track_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Self) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0 as *mut _, "notify::track",
